...
function getDefaultConfig(projectRoot, options = {}) {
    ...
    const target = (_b = (_a = options.target, (_a !== null && _a !== void 0 ? _a : process.env.EXPO_TARGET)), (_b !== null && _b !== void 0 ? _b : config_1.getDefaultTarget(projectRoot)));
...
async function loadAsync(projectRoot, _a = {}) {
    ...
    return await loadConfig(Object.assign({ cwd: projectRoot, projectRoot }, metroOptions), defaultConfig);
}
